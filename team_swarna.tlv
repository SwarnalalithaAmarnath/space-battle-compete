...
\TLV
   ...
   ///m5_team(now_changed_logic, Swarna)
  /// m5_team(opponent_logic, Opponent)
...
\SV
   ...
   m4_ifdef(['m5']team\m5_get_ago(github_id, 0)module, ['m5_call(team\m5_get_ago(github_id, 0)_module)'])
   m4_ifdef(['m5']team\m5_get_ago(github_id, 1)module, ['m5_call(team\m5_get_ago(github_id, 1)_module)'])
